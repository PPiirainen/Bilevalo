...
#define BUTTON_3  2   //Button 3 toggles shuffle mode (automated changing of color and visual)
...
float maxVol = 15;    //Holds the largest volume recorded thus far to proportionally adjust the visual's responsiveness.
  //Holds the percentage of how twisted the trimpot is. Used for adjusting the max brightness.
